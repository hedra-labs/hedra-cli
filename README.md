...
| Command | Description |
|---------|-------------|
| `hedra-cli workspaces list` | List accessible workspaces (`★` marks the active one, and shows which have a key held locally). This is the default — bare `hedra-cli workspaces` runs it |
