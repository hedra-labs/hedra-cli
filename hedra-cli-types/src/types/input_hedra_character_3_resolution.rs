...
pub enum InputHedraCharacter3Resolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputHedraCharacter3Resolution {
...
impl<'de> Deserialize<'de> for InputHedraCharacter3Resolution {
...
impl fmt::Display for InputHedraCharacter3Resolution {
