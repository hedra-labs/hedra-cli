...
pub enum InputPixverseV6AspectRatio {
    Sixteen9,
    Four3,
    One1,
    Three4,
...
impl Serialize for InputPixverseV6AspectRatio {
...
impl<'de> Deserialize<'de> for InputPixverseV6AspectRatio {
...
impl fmt::Display for InputPixverseV6AspectRatio {
