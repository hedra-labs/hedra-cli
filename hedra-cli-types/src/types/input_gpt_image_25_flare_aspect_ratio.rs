...
pub enum InputGptImage25FlareAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputGptImage25FlareAspectRatio {
...
impl<'de> Deserialize<'de> for InputGptImage25FlareAspectRatio {
...
impl fmt::Display for InputGptImage25FlareAspectRatio {
