...
pub enum InputLumaRay32Resolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputLumaRay32Resolution {
...
impl<'de> Deserialize<'de> for InputLumaRay32Resolution {
...
impl fmt::Display for InputLumaRay32Resolution {
