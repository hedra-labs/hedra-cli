...
pub enum InputKlingO3EditResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputKlingO3EditResolution {
...
impl<'de> Deserialize<'de> for InputKlingO3EditResolution {
...
impl fmt::Display for InputKlingO3EditResolution {
