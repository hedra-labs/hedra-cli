...
pub enum InputSeedance25Resolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for InputSeedance25Resolution {
...
impl<'de> Deserialize<'de> for InputSeedance25Resolution {
...
impl fmt::Display for InputSeedance25Resolution {
