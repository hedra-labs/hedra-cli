...
pub enum InputSeedance20MiniResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for InputSeedance20MiniResolution {
...
impl<'de> Deserialize<'de> for InputSeedance20MiniResolution {
...
impl fmt::Display for InputSeedance20MiniResolution {
