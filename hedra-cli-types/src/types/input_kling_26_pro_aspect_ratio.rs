...
pub enum InputKling26ProAspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputKling26ProAspectRatio {
...
impl<'de> Deserialize<'de> for InputKling26ProAspectRatio {
...
impl fmt::Display for InputKling26ProAspectRatio {
