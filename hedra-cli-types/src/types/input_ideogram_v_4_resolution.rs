...
pub enum InputIdeogramV4Resolution {
    SevenHundredTwentyP,
...
impl Serialize for InputIdeogramV4Resolution {
...
impl<'de> Deserialize<'de> for InputIdeogramV4Resolution {
...
impl fmt::Display for InputIdeogramV4Resolution {
