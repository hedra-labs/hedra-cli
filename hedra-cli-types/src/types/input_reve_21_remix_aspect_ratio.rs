...
pub enum InputReve21RemixAspectRatio {
    Four1,
    Three1,
    TwentyOne9,
    Two1,
...
impl Serialize for InputReve21RemixAspectRatio {
...
impl<'de> Deserialize<'de> for InputReve21RemixAspectRatio {
...
impl fmt::Display for InputReve21RemixAspectRatio {
