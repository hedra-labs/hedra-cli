...
pub enum InputOmnihuman15Resolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputOmnihuman15Resolution {
...
impl<'de> Deserialize<'de> for InputOmnihuman15Resolution {
...
impl fmt::Display for InputOmnihuman15Resolution {
