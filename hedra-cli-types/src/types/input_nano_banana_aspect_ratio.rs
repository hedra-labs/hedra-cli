...
pub enum InputNanoBananaAspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputNanoBananaAspectRatio {
...
impl<'de> Deserialize<'de> for InputNanoBananaAspectRatio {
...
impl fmt::Display for InputNanoBananaAspectRatio {
