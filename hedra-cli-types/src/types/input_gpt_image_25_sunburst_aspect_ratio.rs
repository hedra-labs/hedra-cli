...
pub enum InputGptImage25SunburstAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputGptImage25SunburstAspectRatio {
...
impl<'de> Deserialize<'de> for InputGptImage25SunburstAspectRatio {
...
impl fmt::Display for InputGptImage25SunburstAspectRatio {
