...
pub enum InputGrokVideoResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for InputGrokVideoResolution {
...
impl<'de> Deserialize<'de> for InputGrokVideoResolution {
...
impl fmt::Display for InputGrokVideoResolution {
