...
pub enum InputSeedream40Resolution {
    OneThousandEightyP,
...
impl Serialize for InputSeedream40Resolution {
...
impl<'de> Deserialize<'de> for InputSeedream40Resolution {
...
impl fmt::Display for InputSeedream40Resolution {
