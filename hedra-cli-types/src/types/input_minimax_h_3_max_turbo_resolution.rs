...
pub enum InputMinimaxH3MaxTurboResolution {
    FourHundredEightyP,
...
impl Serialize for InputMinimaxH3MaxTurboResolution {
...
impl<'de> Deserialize<'de> for InputMinimaxH3MaxTurboResolution {
...
impl fmt::Display for InputMinimaxH3MaxTurboResolution {
