...
pub enum InputSeedance20MiniAspectRatio {
    One1,
    Three4,
    Four3,
    Sixteen9,
...
impl Serialize for InputSeedance20MiniAspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedance20MiniAspectRatio {
...
impl fmt::Display for InputSeedance20MiniAspectRatio {
