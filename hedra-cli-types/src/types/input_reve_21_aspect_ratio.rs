...
pub enum InputReve21AspectRatio {
    Four1,
    Three1,
    TwentyOne9,
    Two1,
...
impl Serialize for InputReve21AspectRatio {
...
impl<'de> Deserialize<'de> for InputReve21AspectRatio {
...
impl fmt::Display for InputReve21AspectRatio {
