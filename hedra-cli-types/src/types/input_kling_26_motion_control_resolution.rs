...
pub enum InputKling26MotionControlResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputKling26MotionControlResolution {
...
impl<'de> Deserialize<'de> for InputKling26MotionControlResolution {
...
impl fmt::Display for InputKling26MotionControlResolution {
