...
pub enum InputViduQ3AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputViduQ3AspectRatio {
...
impl<'de> Deserialize<'de> for InputViduQ3AspectRatio {
...
impl fmt::Display for InputViduQ3AspectRatio {
