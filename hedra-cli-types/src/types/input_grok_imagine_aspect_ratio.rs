...
pub enum InputGrokImagineAspectRatio {
    Auto,
    Two1,
    Twenty9,
    Nineteen59,
...
impl Serialize for InputGrokImagineAspectRatio {
...
impl<'de> Deserialize<'de> for InputGrokImagineAspectRatio {
...
impl fmt::Display for InputGrokImagineAspectRatio {
