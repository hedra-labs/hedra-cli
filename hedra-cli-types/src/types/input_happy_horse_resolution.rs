...
pub enum InputHappyHorseResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputHappyHorseResolution {
...
impl<'de> Deserialize<'de> for InputHappyHorseResolution {
...
impl fmt::Display for InputHappyHorseResolution {
