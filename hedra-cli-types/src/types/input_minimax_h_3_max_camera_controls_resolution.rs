...
pub enum InputMinimaxH3MaxCameraControlsResolution {
    FourHundredEightyP,
...
impl Serialize for InputMinimaxH3MaxCameraControlsResolution {
...
impl<'de> Deserialize<'de> for InputMinimaxH3MaxCameraControlsResolution {
...
impl fmt::Display for InputMinimaxH3MaxCameraControlsResolution {
