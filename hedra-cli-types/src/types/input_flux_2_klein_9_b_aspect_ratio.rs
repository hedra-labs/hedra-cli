...
pub enum InputFlux2Klein9BAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputFlux2Klein9BAspectRatio {
...
impl<'de> Deserialize<'de> for InputFlux2Klein9BAspectRatio {
...
impl fmt::Display for InputFlux2Klein9BAspectRatio {
