...
pub enum InputFluxKontextProAspectRatio {
    Sixteen9,
    Nine16,
    One1,
    Four3,
...
impl Serialize for InputFluxKontextProAspectRatio {
...
impl<'de> Deserialize<'de> for InputFluxKontextProAspectRatio {
...
impl fmt::Display for InputFluxKontextProAspectRatio {
