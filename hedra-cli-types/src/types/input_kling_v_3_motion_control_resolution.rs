...
pub enum InputKlingV3MotionControlResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputKlingV3MotionControlResolution {
...
impl<'de> Deserialize<'de> for InputKlingV3MotionControlResolution {
...
impl fmt::Display for InputKlingV3MotionControlResolution {
