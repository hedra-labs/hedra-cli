...
pub enum InputVeedFabric10Resolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for InputVeedFabric10Resolution {
...
impl<'de> Deserialize<'de> for InputVeedFabric10Resolution {
...
impl fmt::Display for InputVeedFabric10Resolution {
