...
pub enum InputVeedFabric10AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputVeedFabric10AspectRatio {
...
impl<'de> Deserialize<'de> for InputVeedFabric10AspectRatio {
...
impl fmt::Display for InputVeedFabric10AspectRatio {
