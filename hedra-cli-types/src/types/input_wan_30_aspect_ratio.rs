...
pub enum InputWan30AspectRatio {
    Adaptive,
    Sixteen9,
    Four3,
    One1,
...
impl Serialize for InputWan30AspectRatio {
...
impl<'de> Deserialize<'de> for InputWan30AspectRatio {
...
impl fmt::Display for InputWan30AspectRatio {
