...
pub enum InputIdeogramV4AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputIdeogramV4AspectRatio {
...
impl<'de> Deserialize<'de> for InputIdeogramV4AspectRatio {
...
impl fmt::Display for InputIdeogramV4AspectRatio {
