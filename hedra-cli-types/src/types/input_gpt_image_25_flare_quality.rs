...
pub enum InputGptImage25FlareQuality {
    Auto,
    Low,
    Medium,
    High,
...
impl Serialize for InputGptImage25FlareQuality {
...
impl<'de> Deserialize<'de> for InputGptImage25FlareQuality {
...
impl fmt::Display for InputGptImage25FlareQuality {
