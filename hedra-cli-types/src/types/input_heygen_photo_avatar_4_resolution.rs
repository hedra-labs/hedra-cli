...
pub enum InputHeygenPhotoAvatar4Resolution {
    ThreeHundredSixtyP,
    FourHundredEightyP,
    FiveHundredFortyP,
    SevenHundredTwentyP,
...
impl Serialize for InputHeygenPhotoAvatar4Resolution {
...
impl<'de> Deserialize<'de> for InputHeygenPhotoAvatar4Resolution {
...
impl fmt::Display for InputHeygenPhotoAvatar4Resolution {
