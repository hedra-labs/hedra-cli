...
pub enum InputKling21MasterAspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputKling21MasterAspectRatio {
...
impl<'de> Deserialize<'de> for InputKling21MasterAspectRatio {
...
impl fmt::Display for InputKling21MasterAspectRatio {
