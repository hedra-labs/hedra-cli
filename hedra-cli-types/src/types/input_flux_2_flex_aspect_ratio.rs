...
pub enum InputFlux2FlexAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputFlux2FlexAspectRatio {
...
impl<'de> Deserialize<'de> for InputFlux2FlexAspectRatio {
...
impl fmt::Display for InputFlux2FlexAspectRatio {
