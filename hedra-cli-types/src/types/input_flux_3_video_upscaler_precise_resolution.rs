...
pub enum InputFlux3VideoUpscalerPreciseResolution {
    OneThousandEightyP,
    TwoK,
    FourK,
...
impl Serialize for InputFlux3VideoUpscalerPreciseResolution {
...
impl<'de> Deserialize<'de> for InputFlux3VideoUpscalerPreciseResolution {
...
impl fmt::Display for InputFlux3VideoUpscalerPreciseResolution {
