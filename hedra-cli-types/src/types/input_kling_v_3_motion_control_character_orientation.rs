...
pub enum InputKlingV3MotionControlCharacterOrientation {
    Image,
    Video,
...
impl Serialize for InputKlingV3MotionControlCharacterOrientation {
...
impl<'de> Deserialize<'de> for InputKlingV3MotionControlCharacterOrientation {
...
impl fmt::Display for InputKlingV3MotionControlCharacterOrientation {
