...
pub enum InputTopazImageUpscalerTargetResolution {
    OneThousandEightyP,
    TwoK,
    FourK,
...
impl Serialize for InputTopazImageUpscalerTargetResolution {
...
impl<'de> Deserialize<'de> for InputTopazImageUpscalerTargetResolution {
...
impl fmt::Display for InputTopazImageUpscalerTargetResolution {
