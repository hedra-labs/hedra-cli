...
pub enum InputCreatifyAuroraResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
...
impl Serialize for InputCreatifyAuroraResolution {
...
impl<'de> Deserialize<'de> for InputCreatifyAuroraResolution {
...
impl fmt::Display for InputCreatifyAuroraResolution {
