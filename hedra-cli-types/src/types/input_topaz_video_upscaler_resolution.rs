...
pub enum InputTopazVideoUpscalerResolution {
    OneThousandEightyP,
    TwoK,
    FourK,
...
impl Serialize for InputTopazVideoUpscalerResolution {
...
impl<'de> Deserialize<'de> for InputTopazVideoUpscalerResolution {
...
impl fmt::Display for InputTopazVideoUpscalerResolution {
