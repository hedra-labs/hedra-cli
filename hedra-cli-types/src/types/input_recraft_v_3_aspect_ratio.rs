...
pub enum InputRecraftV3AspectRatio {
    One1,
    One3,
    Two3,
    Three1,
...
impl Serialize for InputRecraftV3AspectRatio {
...
impl<'de> Deserialize<'de> for InputRecraftV3AspectRatio {
...
impl fmt::Display for InputRecraftV3AspectRatio {
