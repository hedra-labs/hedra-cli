...
pub enum InputHidreamO1ImageResolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputHidreamO1ImageResolution {
...
impl<'de> Deserialize<'de> for InputHidreamO1ImageResolution {
...
impl fmt::Display for InputHidreamO1ImageResolution {
