...
pub enum InputMinimaxH3MaxTurboAspectRatio {
    Three4,
    Four3,
    One1,
    Nine16,
...
impl Serialize for InputMinimaxH3MaxTurboAspectRatio {
...
impl<'de> Deserialize<'de> for InputMinimaxH3MaxTurboAspectRatio {
...
impl fmt::Display for InputMinimaxH3MaxTurboAspectRatio {
