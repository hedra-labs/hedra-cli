...
pub enum InputKling16Resolution {
    OneThousandEightyP,
    SevenHundredTwentyP,
...
impl Serialize for InputKling16Resolution {
...
impl<'de> Deserialize<'de> for InputKling16Resolution {
...
impl fmt::Display for InputKling16Resolution {
