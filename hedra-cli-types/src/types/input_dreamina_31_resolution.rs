...
pub enum InputDreamina31Resolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputDreamina31Resolution {
...
impl<'de> Deserialize<'de> for InputDreamina31Resolution {
...
impl fmt::Display for InputDreamina31Resolution {
