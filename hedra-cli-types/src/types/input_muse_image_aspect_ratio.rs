...
pub enum InputMuseImageAspectRatio {
    Adaptive,
    TwentyOne9,
    Sixteen9,
    Three2,
...
impl Serialize for InputMuseImageAspectRatio {
...
impl<'de> Deserialize<'de> for InputMuseImageAspectRatio {
...
impl fmt::Display for InputMuseImageAspectRatio {
