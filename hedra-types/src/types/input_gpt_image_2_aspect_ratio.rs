...
pub enum InputGptImage2AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputGptImage2AspectRatio {
...
impl<'de> Deserialize<'de> for InputGptImage2AspectRatio {
...
impl fmt::Display for InputGptImage2AspectRatio {
