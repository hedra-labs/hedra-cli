...
pub enum InputWan27AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputWan27AspectRatio {
...
impl<'de> Deserialize<'de> for InputWan27AspectRatio {
...
impl fmt::Display for InputWan27AspectRatio {
