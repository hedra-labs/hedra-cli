...
pub enum InputFlux3AspectRatio {
    Auto,
    TwentyOne9,
    Two1,
    Sixteen9,
...
impl Serialize for InputFlux3AspectRatio {
...
impl<'de> Deserialize<'de> for InputFlux3AspectRatio {
...
impl fmt::Display for InputFlux3AspectRatio {
