...
pub enum InputHedraAvatarResolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputHedraAvatarResolution {
...
impl<'de> Deserialize<'de> for InputHedraAvatarResolution {
...
impl fmt::Display for InputHedraAvatarResolution {
