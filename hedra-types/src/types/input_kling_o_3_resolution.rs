...
pub enum InputKlingO3Resolution {
    OneThousandEightyP,
    FourK,
    SevenHundredTwentyP,
...
impl Serialize for InputKlingO3Resolution {
...
impl<'de> Deserialize<'de> for InputKlingO3Resolution {
...
impl fmt::Display for InputKlingO3Resolution {
