...
pub enum InputHidreamO1ImageAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputHidreamO1ImageAspectRatio {
...
impl<'de> Deserialize<'de> for InputHidreamO1ImageAspectRatio {
...
impl fmt::Display for InputHidreamO1ImageAspectRatio {
