...
pub enum InputSeedream50ProAspectRatio {
    One1,
    One3,
    Two3,
    Three1,
...
impl Serialize for InputSeedream50ProAspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedream50ProAspectRatio {
...
impl fmt::Display for InputSeedream50ProAspectRatio {
