...
pub enum InputHedraAvatarAspectRatio {
    One1,
    Four3,
    Three4,
    Sixteen9,
...
impl Serialize for InputHedraAvatarAspectRatio {
...
impl<'de> Deserialize<'de> for InputHedraAvatarAspectRatio {
...
impl fmt::Display for InputHedraAvatarAspectRatio {
