...
pub enum InputIdeogramV2AspectRatio {
    One1,
    One3,
    Two3,
    Three1,
...
impl Serialize for InputIdeogramV2AspectRatio {
...
impl<'de> Deserialize<'de> for InputIdeogramV2AspectRatio {
...
impl fmt::Display for InputIdeogramV2AspectRatio {
