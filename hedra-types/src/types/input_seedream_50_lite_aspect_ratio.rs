...
pub enum InputSeedream50LiteAspectRatio {
    One1,
    One3,
    Two3,
    Three1,
...
impl Serialize for InputSeedream50LiteAspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedream50LiteAspectRatio {
...
impl fmt::Display for InputSeedream50LiteAspectRatio {
