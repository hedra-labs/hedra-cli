...
pub enum InputSeedream45AspectRatio {
    One1,
    One3,
    Two3,
    Three1,
...
impl Serialize for InputSeedream45AspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedream45AspectRatio {
...
impl fmt::Display for InputSeedream45AspectRatio {
