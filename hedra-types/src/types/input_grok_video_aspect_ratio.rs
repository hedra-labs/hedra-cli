...
pub enum InputGrokVideoAspectRatio {
    Auto,
    Sixteen9,
    Four3,
    Three2,
...
impl Serialize for InputGrokVideoAspectRatio {
...
impl<'de> Deserialize<'de> for InputGrokVideoAspectRatio {
...
impl fmt::Display for InputGrokVideoAspectRatio {
