...
pub enum InputSeedance20AspectRatio {
    One1,
    Three4,
    Four3,
    Sixteen9,
...
impl Serialize for InputSeedance20AspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedance20AspectRatio {
...
impl fmt::Display for InputSeedance20AspectRatio {
