...
pub enum InputImagen3AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputImagen3AspectRatio {
...
impl<'de> Deserialize<'de> for InputImagen3AspectRatio {
...
impl fmt::Display for InputImagen3AspectRatio {
