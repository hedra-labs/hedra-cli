...
pub enum InputFluxDevResolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputFluxDevResolution {
...
impl<'de> Deserialize<'de> for InputFluxDevResolution {
...
impl fmt::Display for InputFluxDevResolution {
