...
pub enum InputKlingAiAvatarV2AspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputKlingAiAvatarV2AspectRatio {
...
impl<'de> Deserialize<'de> for InputKlingAiAvatarV2AspectRatio {
...
impl fmt::Display for InputKlingAiAvatarV2AspectRatio {
