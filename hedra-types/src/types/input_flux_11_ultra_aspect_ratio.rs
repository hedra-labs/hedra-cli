...
pub enum InputFlux11UltraAspectRatio {
    Sixteen9,
    Nine16,
    One1,
    Four3,
...
impl Serialize for InputFlux11UltraAspectRatio {
...
impl<'de> Deserialize<'de> for InputFlux11UltraAspectRatio {
...
impl fmt::Display for InputFlux11UltraAspectRatio {
