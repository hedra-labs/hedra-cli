...
pub enum InputFlux2ProAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputFlux2ProAspectRatio {
...
impl<'de> Deserialize<'de> for InputFlux2ProAspectRatio {
...
impl fmt::Display for InputFlux2ProAspectRatio {
