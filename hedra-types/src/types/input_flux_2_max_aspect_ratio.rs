...
pub enum InputFlux2MaxAspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputFlux2MaxAspectRatio {
...
impl<'de> Deserialize<'de> for InputFlux2MaxAspectRatio {
...
impl fmt::Display for InputFlux2MaxAspectRatio {
