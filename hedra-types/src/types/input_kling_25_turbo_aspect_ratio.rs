...
pub enum InputKling25TurboAspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputKling25TurboAspectRatio {
...
impl<'de> Deserialize<'de> for InputKling25TurboAspectRatio {
...
impl fmt::Display for InputKling25TurboAspectRatio {
