...
pub enum InputRecraftV3Resolution {
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputRecraftV3Resolution {
...
impl<'de> Deserialize<'de> for InputRecraftV3Resolution {
...
impl fmt::Display for InputRecraftV3Resolution {
