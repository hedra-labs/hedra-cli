...
pub enum InputSora2ProResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputSora2ProResolution {
...
impl<'de> Deserialize<'de> for InputSora2ProResolution {
...
impl fmt::Display for InputSora2ProResolution {
