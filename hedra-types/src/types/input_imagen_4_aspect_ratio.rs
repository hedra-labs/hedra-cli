...
pub enum InputImagen4AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputImagen4AspectRatio {
...
impl<'de> Deserialize<'de> for InputImagen4AspectRatio {
...
impl fmt::Display for InputImagen4AspectRatio {
