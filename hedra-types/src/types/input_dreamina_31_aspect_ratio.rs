...
pub enum InputDreamina31AspectRatio {
    Sixteen9,
    Nine16,
    One1,
    Four3,
...
impl Serialize for InputDreamina31AspectRatio {
...
impl<'de> Deserialize<'de> for InputDreamina31AspectRatio {
...
impl fmt::Display for InputDreamina31AspectRatio {
