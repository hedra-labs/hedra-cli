...
pub enum InputSeedream40AspectRatio {
    One1,
    One3,
    Two3,
    Three1,
...
impl Serialize for InputSeedream40AspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedream40AspectRatio {
...
impl fmt::Display for InputSeedream40AspectRatio {
