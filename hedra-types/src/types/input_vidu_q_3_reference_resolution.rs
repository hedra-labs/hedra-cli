...
pub enum InputViduQ3ReferenceResolution {
    ThreeHundredSixtyP,
    FiveHundredFortyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputViduQ3ReferenceResolution {
...
impl<'de> Deserialize<'de> for InputViduQ3ReferenceResolution {
...
impl fmt::Display for InputViduQ3ReferenceResolution {
