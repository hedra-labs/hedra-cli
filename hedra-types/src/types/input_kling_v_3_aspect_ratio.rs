...
pub enum InputKlingV3AspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputKlingV3AspectRatio {
...
impl<'de> Deserialize<'de> for InputKlingV3AspectRatio {
...
impl fmt::Display for InputKlingV3AspectRatio {
