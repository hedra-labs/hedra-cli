...
pub enum InputSeedance25AspectRatio {
    One1,
    Three4,
    Four3,
    Sixteen9,
...
impl Serialize for InputSeedance25AspectRatio {
...
impl<'de> Deserialize<'de> for InputSeedance25AspectRatio {
...
impl fmt::Display for InputSeedance25AspectRatio {
