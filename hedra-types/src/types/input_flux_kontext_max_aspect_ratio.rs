...
pub enum InputFluxKontextMaxAspectRatio {
    Sixteen9,
    Nine16,
    One1,
    Four3,
...
impl Serialize for InputFluxKontextMaxAspectRatio {
...
impl<'de> Deserialize<'de> for InputFluxKontextMaxAspectRatio {
...
impl fmt::Display for InputFluxKontextMaxAspectRatio {
