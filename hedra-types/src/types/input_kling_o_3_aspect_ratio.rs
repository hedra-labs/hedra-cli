...
pub enum InputKlingO3AspectRatio {
    Sixteen9,
    Nine16,
    One1,
...
impl Serialize for InputKlingO3AspectRatio {
...
impl<'de> Deserialize<'de> for InputKlingO3AspectRatio {
...
impl fmt::Display for InputKlingO3AspectRatio {
