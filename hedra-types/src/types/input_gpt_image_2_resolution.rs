...
pub enum InputGptImage2Resolution {
    OneK,
    TwoK,
    FourK,
...
impl Serialize for InputGptImage2Resolution {
...
impl<'de> Deserialize<'de> for InputGptImage2Resolution {
...
impl fmt::Display for InputGptImage2Resolution {
