...
pub struct GenerateSpeechToSpeechRequest {
...
impl GenerateSpeechToSpeechRequest {
    pub fn builder() -> GenerateSpeechToSpeechRequestBuilder {
        <GenerateSpeechToSpeechRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GenerateSpeechToSpeechRequestBuilder {
...
impl GenerateSpeechToSpeechRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`GenerateSpeechToSpeechRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`audio_id`](GenerateSpeechToSpeechRequestBuilder::audio_id)
    /// - [`ai_model_id`](GenerateSpeechToSpeechRequestBuilder::ai_model_id)
    /// - [`voice_id`](GenerateSpeechToSpeechRequestBuilder::voice_id)
    pub fn build(self) -> Result<GenerateSpeechToSpeechRequest, BuildError> {
        Ok(GenerateSpeechToSpeechRequest {
