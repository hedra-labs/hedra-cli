...
pub enum InputQwenImage2AspectRatio {
    Sixteen9,
    Nine16,
    Four3,
    Three4,
...
impl Serialize for InputQwenImage2AspectRatio {
...
impl<'de> Deserialize<'de> for InputQwenImage2AspectRatio {
...
impl fmt::Display for InputQwenImage2AspectRatio {
