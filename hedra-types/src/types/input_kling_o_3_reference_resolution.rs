...
pub enum InputKlingO3ReferenceResolution {
    SevenHundredTwentyP,
    OneThousandEightyP,
...
impl Serialize for InputKlingO3ReferenceResolution {
...
impl<'de> Deserialize<'de> for InputKlingO3ReferenceResolution {
...
impl fmt::Display for InputKlingO3ReferenceResolution {
